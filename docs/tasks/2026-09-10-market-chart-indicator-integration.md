...
> 2026-09-17 后续范围：打开与最新端更新、双向加载及未收盘日线展示由 [行情图表更新实施任务](2026-09-17-market-chart-refresh.md) 承担。本文件已勾选任务保留当时验收边界，不代表后续行为已实现；包括 T3 当时不绘制 `incomplete` K 线的历史完成条件，后续以新 Spec/Task 为准。
