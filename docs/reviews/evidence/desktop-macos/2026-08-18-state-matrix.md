...
Android API 35 的 Portfolio/Risk 五类状态与 1080×2400、600×1000 小屏证据仍归档在 `docs/reviews/evidence/mobile-android/`；同一隔离 `fixture-account` 的 Desktop/Mobile 数值和 Risk 事件对照见 `2026-08-18-desktop-mobile-fixture-comparison.md`。
