...
- M2：通过。macOS Desktop release 与 Android release 使用同一隔离 `fixture-account`，总市值 `CN¥178,000.00`、总成本 `CN¥160,000.00`、累计盈亏 `CN¥18,000.00`、`600519.SH` 数量 100 和 Risk warning 事件均一致；对照报告见 `docs/reviews/evidence/mobile-android/desktop-mobile-fixture-comparison.md`。
