...
当前目录只保留仍用于发布门禁、运行阻塞或跨仓审计的 Review：

- `2026-08-18-v1.0-release-gate-review.md`：当前 V1 发布门禁总结；
- `2026-08-18-v1-core-e2e-report.md`、`2026-08-18-v1-disaster-recovery-report.md`：发布门禁引用的核心运行报告；
...
`evidence/` 下的截图、XML 和一次性运行产物只作为验证证据，不作为产品需求或运行手册。外部归档和发布附件确认前，不删除现有证据。

主题 Review 文件使用 `YYYY-MM-DD-<topic>.md` 命名；`README.md` 仅作为目录入口，保留标准名称。
