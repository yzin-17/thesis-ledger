...
- 2026-08-01 再次将 release DMG 的 `/api` 代理指向运行中的 Docker Compose Server，完成 Portfolio、Import 草稿/提交、Risk 规则、Strategy/Backtest、Journal、AI 和 Provider/Automation 页面烟测；真实 API、窗口尺寸和操作记录见 `docs/reviews/evidence/desktop-macos/compose-release-e2e.md`。
